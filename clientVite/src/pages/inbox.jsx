      ...
      <div className="rounded-2xl bg-white w-[370px] h-[715px] shadow-xl flex flex-col justify-between overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="flex flex-col items-center mt-10 text-center">
            ...
            <p className="font-semibold text-lg text-gray-800">No messages</p>
            <p className="text-sm text-gray-500">wait for someone!</p>
            <br /> <br /><br />
            <br />
        ...
        <div className="flex justify-around items-center h-14 border-t bg-white">
          ...
          <Link to="/inbox">
            <BsInboxFill className="text-blue-700" size={20} />
          </Link>
          <Link to="/activity">
